...
export function FloorPlanSettings() {
  ...
  return (
    <div className="p-3 border-b border-gray-200 space-y-3">
      <h3 className="text-xs font-semibold text-gray-500 uppercase tracking-wider">{t('floorPlanTitle')}</h3>
      ...
      {floorPlan.imageData ? (
        ...
        >
          ...
          <p className="text-xs text-gray-500 font-medium">{t('uploadFloorPlan')}</p>
      ...
      <div className="space-y-1">
        <label className="text-xs text-gray-500 font-medium">{t('canvasSize')}</label>
        <div className="grid grid-cols-2 gap-2">
          <div>
            <label className="text-xs text-gray-400">{t('widthPx')}</label>
            <input
          ...
          <div>
            <label className="text-xs text-gray-400">{t('heightPx')}</label>
            <input
              type="number" min={200} max={5000}
